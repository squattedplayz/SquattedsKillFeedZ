    ...
    <body>
        <div class="sidebar">
            ...
            <ul class="menu-list">
                ...
                <a href="/?tab=zones" class="menu-item {'active' if tab == 'zones' else ''}">Zones & Safe Zones</a>
        ...
        <div class="main-container">
            ...
            <div class="content">
                ...
                {"<div class='card'><h2>Zones & Safe Zones Configuration</h2><p>Configure trading zones, safe zones, and restricted military loot zones.</p><div class='toggle-row'><span>Safe Zone Godmode Enabled</span><label class='switch'><input type='checkbox' checked><span class='slider'></span></label></div><div style='margin-top:20px;'><label style='color:#c084fc;'>Active Trade Zone Coordinates & Radius</label><input type='text' class='form-input' value='[11500, 4200, 300]'></div><button class='action-btn' style='margin-top:10px;'>Save Zone Settings</button></div>" if tab == 'zones' else ""}
